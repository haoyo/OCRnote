...
Page({
  ...
  onLoad: function (options) {
    ...
    // console.log(_this.data.TitleList.data)
   // this.data.TitleList = JSON.parse(options.data);
    console.log("用户TitleList" + _this.data.TitleList._id);

        if (_this.data.TitleList.identification == null) {
          for (var i = 0; i < _this.data.TitleList.data.items.length; i++) {
